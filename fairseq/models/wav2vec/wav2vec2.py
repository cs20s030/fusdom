...
class Wav2Vec2Config(FairseqDataclass):
    ...
    teacher_path: str = field(
        default="/nlsasfs/home/nltm-pilot/vasistal/Domain_Adaptation/conventional_ft/fairseq/examples/wav2vec/xlsr2_300m.pt",
        metadata={
...
#model_path = '/nlsasfs/home/nltm-pilot/vasistal/Domain_Adaptation/conventional_ft/fairseq/examples/wav2vec/xlsr2_300m.pt'

#model_teach, cfg, task = fairseq.checkpoint_utils.load_model_ensemble_and_task([model_path])
#model_teach = model_teach[0]
#model_teach.eval()
...
class Wav2Vec2Model(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2Config):
        ...
        #if self.cfg.distill:
        #    self.teacher = self.get_teacher_model()
        #else:
        #    self.teacher = None
        #print(self.cfg.distill)
        #except:
            #self.teacher = None            
    ...
    #    model_teacher = load_model_ensemble_and_task([self.cfg.teacher_path])[0][0]
    ...
    def forward(
        ...
        #teacher_feature = self.teacher.extract_features(source, padding_mask)
...
@register_model("wav2vec2_distill", dataclass=Wav2Vec2Config)
class Wav2Vec2Model(BaseFairseqModel):
    def __init__(self, cfg: Wav2Vec2Config):
        super().__init__()
        self.cfg = cfg
